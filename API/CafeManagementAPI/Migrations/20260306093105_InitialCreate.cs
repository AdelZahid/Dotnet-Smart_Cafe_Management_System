        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CafeName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CafeProfiles_Users_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdditionalCosts_CafeProfiles_CafeId",
                        column: x => x.CafeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_CafeProfiles_CafeId",
                        column: x => x.CafeId,
                        principalTable: "CafeProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingredients_CafeProfiles_CafeId",
                        column: x => x.CafeId,
                        principalTable: "CafeProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemCategories_CafeProfiles_CafeId",
                        column: x => x.CafeId,
                        principalTable: "CafeProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tables_CafeProfiles_CafeId",
                        column: x => x.CafeId,
                        principalTable: "CafeProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityWasted = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItems_CafeProfiles_CafeId",
                        column: x => x.CafeId,
                        principalTable: "CafeProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuItems_ItemCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_CafeProfiles_CafeId",
                        column: x => x.CafeId,
                        principalTable: "CafeProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_CafeProfiles_CafeId",
                        column: x => x.CafeId,
                        principalTable: "CafeProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdditionalCosts_CafeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientUsages_IngredientId_UsageDate",
                table: "IngredientUsages",
                columns: new[] { "IngredientId", "UsageDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ItemCategories_CafeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tables_CafeId_TableNumber",
                table: "Tables",
                columns: new[] { "CafeId", "TableNumber" },
                unique: true);
